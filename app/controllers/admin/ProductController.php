...
class ProductController extends AppController
{
    public function indexAction(){
        ...
        $products = \R::getAll("SELECT product.*, category.title AS cat FROM product JOIN category 
    ON category.id = product.category_id ORDER BY product.title LIMIT $start, $perpage");
